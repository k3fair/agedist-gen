...
Code containg functions needed to calculate survival probabiltiies for, and simulate age distribution with, model 1 (no activation rates).
...
# Run a simulation with this set of surivival probabilities
...
pd.DataFrame(analytical_survival_probs).to_csv(f'{home}data/survivalprobs_{df.iloc[numselect,3]}_model1.csv', index=False, header=False)
