...
while True:
    ...
    if fitness[best_idx] < best_fitness:
        ...
        plt.savefig(f'agedist_{df.iloc[numselect,3]}_model2_activation.png', bbox_inches="tight", dpi=300)
        plt.show()
    ...
    if best_fitness < algthresh:
        ...
        pd.DataFrame(best_sol).to_csv('%sdata/bestparms_{df.iloc[numselect,3]}_model2_activation.csv' % home) 
