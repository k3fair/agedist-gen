...
def pop_refine(pop_member):
        ...
        while any(x > 1 for x in survive_probas):
            ...
            if fix_attempt == 1e3:
                ...
                print("Too many attempts to fix parameter set - moving on... User may want to consider curve fitting approach for their age distribution if this message appears frequently.")
